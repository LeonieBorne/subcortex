...
if Figures
    ...
    if Mag
        saveas(hf,[Subject,'magnitude_sagittal.png']);
    else
        saveas(hf,[Subject,'eigenmap_sagittal.png']);
    end
    ...
    if Mag
        saveas(hf,[Subject,'magnitude_coronal.png']);
    else
        saveas(hf,[Subject,'eigenmap_coronal.png']);
    end
    ...
    if Mag
        saveas(hf,[Subject,'magnitude_axial.png']);
    else
        saveas(hf,[Subject,'eigenmap_axial.png']);
    end
    end
end
